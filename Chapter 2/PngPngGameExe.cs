...
namespace WindowsFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        private void timer_tick(object sender, EventArgs e)
        {
            ...
            if (downPressed && leftPaddleY < this.Height - 100) leftPaddleY += paddlespeed;
            if (wPressed && rightPaddleY > 0) rightPaddleY -= paddlespeed;
            if (sPressed && rightPaddleY < this.Height - 100) rightPaddleY += paddlespeed;
            ...
            if (ball_X_Pos <= 45 && ball_X_Pos >= 30)
            {
                ...
                {
                    ball_X_Speed = Math.Abs(ball_X_Speed)+1;
                    ball_X_Pos = 46;
                }
            }
            ...
            if (ball_X_Pos + ball_Size >= rightPaddleX && ball_X_Pos + ball_Size <= rightPaddleX + paddleHeight)
            {
                ...
                {
                    ball_X_Speed = -Math.Abs(ball_X_Speed)-1;
                    ball_X_Pos = rightPaddleX - ball_Size - 1;
                }
            }
